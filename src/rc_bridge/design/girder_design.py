...
def design_rectangular_girder_ec2(
    ...
    """Run the current EC2 flexure/shear design checks for one girder.

    This is an integration wrapper, not a claim that all EN 1992-2 bridge
    clauses are implemented. T/I flanged flexure, cracking, fatigue, torsion,
    minimum steel, anchorage and detailed reinforcement rules remain separate
    development items.
    """
    if girder_index <= 0:
