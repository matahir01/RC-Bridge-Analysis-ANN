...
4. **Finish generalizing the native simple-span production workflow.** Rectangular, T and I physical profiles now share benchmark-gated native-LM1 positive-bending ULS/SLS, practical detailing and dedicated FLM3 longitudinal/concrete fatigue adapters. Generalize the advanced envelope-curtailment and matched torsion adapters beyond the existing T-girder-specific implementations.
