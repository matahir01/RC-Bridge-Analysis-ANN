...
4. **Finish generalizing the native simple-span production workflow.** Rectangular, T and I physical profiles now share a benchmark-gated native-LM1 positive-bending ULS/SLS and practical detailing adapter. Generalize the advanced envelope-curtailment, matched torsion and FLM3 fatigue adapters beyond the existing T-girder-specific implementations.
