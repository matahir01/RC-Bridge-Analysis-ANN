...
4. **Generalize the native simple-span production workflow.** The common physical rectangular/T/I positive-bending EC2 ULS/SLS and practical detailing kernel is now implemented. Connect it to the benchmark-gated native-LM1 production adapter, then generalize envelope detailing, matched torsion and fatigue beyond the existing T-girder adapter.
